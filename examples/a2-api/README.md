...
The [audit_reports.rb](audit_reports.rb) script provides the export of https://docs.chef.io/automate/api/#operation/Export for the last 24 hours of compliance reports.
...
```
$ ./audit_reports.rb csv > output.csv
```
